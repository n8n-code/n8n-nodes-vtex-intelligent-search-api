...
export class VtexIntelligentSearchApiApi implements ICredentialType {
	name = 'N8nDevVtexIntelligentSearchApiApi';

	displayName = 'vtex-intelligent-search-api API';

	icon: Icon = { light: 'file:../nodes/VtexIntelligentSearchApi/vtex-intelligent-search-api.svg', dark: 'file:../nodes/VtexIntelligentSearchApi/vtex-intelligent-search-api.dark.svg' };
	...
	properties: INodeProperties[] = [
		{
			...
			description: 'The base URL of your vtex-intelligent-search-api API server',
		},
		{
			displayName: 'API Key',
			name: 'apiKey',
